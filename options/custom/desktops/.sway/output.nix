    ...
    home-manager.sharedModules = [
      {
        ...
        wayland.windowManager.sway.config.output = {
          ...
          "*" = {
            ...
            resolution = "${toString config.custom.displays.default.width}x${toString config.custom.displays.default.height}@${toString config.custom.displays.default.refresh}Hz";
            scale = toString config.custom.displays.default.scale;
          };
        };
      }
    ];
