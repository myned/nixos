  ...
  options.custom.settings.storage = {
    ...
    key = {
      ...
      device = mkOption {
        ...
        description = "Path to key device for mount during initrd";
      ...
      path = mkOption {
        ...
        description = "Path to key file on device";
    ...
    root = {
      device = mkOption {
        description = "Path to root device, explicitly required";
        example = "/dev/nvme0n1";
        type = types.path;
      };
      ...
      type = mkOption {
        default = "btrfs";
        description = "Filesystem type of root device";
        example = "ext4";
