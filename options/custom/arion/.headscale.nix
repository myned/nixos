...
with lib; let
  cfg = config.custom.arion.headscale;
in {
  options.custom.arion.headscale = {
    ...
    virtualisation.arion.projects.headscale.settings.services = {
      ...
      headscale.service = {
        ...
        volumes = [
          ...
          "${config.custom.arion.directory}/headscale/data:/var/lib/headscale"
        ];
      };
      ...
      ui.service = {
        ...
        volumes = [
          ...
          "${config.custom.arion.directory}/headscale/ui/data:/var/lib/headplane"
        ];
      };
    };
