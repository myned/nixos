...
with lib; let
  cfg = config.custom.containers.stoat;
in {
  options.custom.containers.stoat = {
  ...
  config = mkIf cfg.enable {
    ...
    virtualisation.arion.projects.stoat.settings.services = {
      ...
      db.service = {
        ...
        network_mode = "service:vpn";
        restart = "unless-stopped";
        volumes = ["${config.custom.containers.directory}/stoat/db:/data/db"];
      ...
      mq.service = {
        ...
        network_mode = "service:vpn";
        restart = "unless-stopped";
        volumes = ["${config.custom.containers.directory}/stoat/mq:/var/lib/rabbitmq"];
      ...
      store.service = {
        ...
        network_mode = "service:vpn";
        restart = "unless-stopped";
        volumes = ["${config.custom.containers.directory}/stoat/store:/data"];
      };
      ...
      vpn.service = {
        ...
        restart = "unless-stopped";
        volumes = ["${config.custom.containers.directory}/stoat/vpn:/var/lib/tailscale"];
